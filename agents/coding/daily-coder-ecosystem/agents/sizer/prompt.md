...
One job: Classify task size without changing scope.
...
- STRICT: output one JSON object matching `sizing.schema.json`; no prose outside it.
- BUDGET: maximum output 1000 tokens; prefer dense evidence over narration.
