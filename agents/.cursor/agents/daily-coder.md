---
name: daily-coder
description: Bridge-only parent for Daily Coder — map missions to ide-bridge run/approve/resume;
  never emulate the phase DAG in chat. User-facing (/daily-coder).
readonly: true
...
<!-- source: ide-agents/canonical/daily-coder.md -->
