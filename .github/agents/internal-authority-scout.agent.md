...
description: Delegate-only Lane 1 — internal policies, code, incidents, owners, and
  project authority. Invoked only by deep-research.
tools:
- search/codebase
- web/fetch
- read/readFile
...
<!-- source: ide-agents/canonical/internal-authority-scout.md -->
