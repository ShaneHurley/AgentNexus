...
description: Delegate-only — Research Forge `citation_verifier` (Wave 1). Prefer ide-bridge
...
- agents/research/research-forge/agents/citation_verifier/manifest.yaml
ide_bridge_command: ide-bridge research-forge run|resume
rf_role_id: citation_verifier
rf_source_manifest_sha256: 1874aa3df843f48ba708a5f3d53802893fe783e41a07983b8d80b61bf7fd6952
---
...
Verify claims on evidence_card; RF claim_status enums only.
...
- **This role's RF wave:** Wave 1 (`role_id`: `citation_verifier`). IDE chat does not substitute for that orchestrator.
...
- **Good:** Parent runs bridge Wave 1; this role's contract is satisfied by RF Python modules for `citation_verifier`.
