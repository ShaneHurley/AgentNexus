...
description: Delegate-only — Research Forge `evidence_extractor` (Wave 1). Prefer
...
- agents/research/research-forge/agents/evidence_extractor/manifest.yaml
ide_bridge_command: ide-bridge research-forge run|resume
rf_role_id: evidence_extractor
rf_source_manifest_sha256: 5336fa59b7a7de3c9f7b9704b162cada7009d7dd359b464dae78661c457e20c7
---
...
Extract evidence_card from source_record; no recommendations field.
...
- **This role's RF wave:** Wave 1 (`role_id`: `evidence_extractor`). IDE chat does not substitute for that orchestrator.
...
- `forbidden_fields`: 'recommendation'
...
- **Good:** Parent runs bridge Wave 1; this role's contract is satisfied by RF Python modules for `evidence_extractor`.
