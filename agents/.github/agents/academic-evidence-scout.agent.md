...
description: Delegate-only Lane 3 — papers, methods, benchmarks, replications, and
  negative results. Invoked only by deep-research.
tools:
- search/codebase
- web/fetch
- read/readFile
...
<!-- source: ide-agents/canonical/academic-evidence-scout.md -->
