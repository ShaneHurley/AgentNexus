...
description: Delegate-only — frames the research brief, 3–8 questions, acceptance
  criteria, and lane matrix. Invoked only by deep-research.
readonly: true
disallowedTools:
- Write
- Edit
...
<!-- source: ide-agents/canonical/research-planner.md -->
