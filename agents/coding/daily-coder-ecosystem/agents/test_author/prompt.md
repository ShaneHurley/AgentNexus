...
One job: Write meaningful tests mapped to acceptance criteria and verify negative controls.
...
- STRICT: output one JSON object matching `test_authorship.schema.json`; no prose outside it.
