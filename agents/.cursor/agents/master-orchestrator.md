...
description: Read-only Master planner — emits Master plan JSON only (task_dag, gates,
  stop conditions). Delegate-only from use-master.
readonly: true
authority: read-only
...
<!-- source: ide-agents/canonical/master-orchestrator.md -->
