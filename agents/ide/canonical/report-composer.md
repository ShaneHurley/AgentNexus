...
description: Delegate-only — Research Forge `report_composer` (Wave 1). Prefer ide-bridge
...
- agents/research/research-forge/agents/report_composer/manifest.yaml
ide_bridge_command: ide-bridge research-forge run|resume
rf_role_id: report_composer
rf_source_manifest_sha256: 437a99cbdbb4e62e6ec4b06696ddcdc52d588ad4df67f4033de569c8e19203b5
---
...
Compose/serialize research_packet for downstream waves.
...
- **This role's RF wave:** Wave 1 (`role_id`: `report_composer`). IDE chat does not substitute for that orchestrator.
...
- **Good:** Parent runs bridge Wave 1; this role's contract is satisfied by RF Python modules for `report_composer`.
