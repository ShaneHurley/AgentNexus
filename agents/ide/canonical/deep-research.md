---
name: deep-research
description: Evidence-first read-only orchestrator for exhaustive multi-lane research; sole parent that may invoke research subagents. User-facing (/deep-research).
readonly: true
authority: read-only
